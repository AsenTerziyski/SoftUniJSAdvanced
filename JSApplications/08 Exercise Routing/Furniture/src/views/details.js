...
const detalsTemplate = (itemPromise) => html`
...
export function detailsPage(ctx) {
    ctx.render(detalsTemplate(loadItem(ctx.params.id, onDelete)));
    // console.log('details view', ctx.params.id);
    async function onDelete(){
        const choice = confirm('Are you sure you wanna delete this item?');
        if (choice) {
